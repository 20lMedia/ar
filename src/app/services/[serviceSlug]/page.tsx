...
const serviceDetailsMap: { [key: string]: any } = {
  residential: {
    ...
    imageUrl: '/images/services/residential-luxury-interior.png',
  ...
  commercial: {
    ...
    imageUrl: '/images/services/commercial-office-lobby.png',
   ...
   styling: {
    ...
    imageUrl: '/images/services/styling-living-room.png',
  ...
  'project-management': {
    ...
    imageUrl: '/images/services/project-management-blueprints.png',
  ...
  'art-curation': {
    ...
    imageUrl: '/images/services/art-curation-gallery.png',
  ...
  'event-design': {
    ...
    imageUrl: '/images/services/event-design-luxury-setup.png',
